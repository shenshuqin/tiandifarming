 ...
 * 分类模型
 *
 * Class Categoryreszxdrwsrt543qrwa
...
//        return DB::table('categorys')->where("type", "article")->pluck("name", "link");
        return DB::table('categorys')->where("type", "article")->select("name", "link")->get();
    }
