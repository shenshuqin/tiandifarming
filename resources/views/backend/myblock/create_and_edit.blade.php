            ...
            <div class="panel">
                <div class="panel-body">
                    ...
                    <form id="form-validator" class="form-horizontal" method="POST" action="{{ $article->id ? route('articles.update', $article->id) : route('articles.store') }}?redirect={{ previous_url() }}">
                        ...
                        {{--<div class="form-group has-feedback  has-icon-right" style="display:none">--}}
                        <div class="form-group has-feedback  has-icon-right" style="display:none">
                            ...
                            <select name="category_id[]" class="chosen-select form-control" id="category_id[]" tabindex="2" multiple="">
                                @foreach($category as $value)
                                    ...
                                    <option @if($value['check']) selected @endif value="{{$value['id']}}">/ {{$value['id']}}{{$value['name']}}</option>
                                @endforeach
                            </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group has-feedback  has-icon-right">
                            <label for="title" class="col-md-2 col-sm-2 control-label">区块名称</label>
                            <div class="col-md-5 col-sm-10">
                            <input type="hidden" name="title" required autocomplete="off" class="form-control" value="{{ old('title',$article->title) }}" >
                        ...
                        {{--<div class="form-group has-feedback  has-icon-right">--}}
                            ...
                            <input type="hidden" name="subtitle" autocomplete="off" class="form-control" value="区块" >
                            {{--</div>--}}
                        {{--</div>--}}
                        ...
                        {{--<div class="form-group has-feedback  has-icon-right">--}}
                            ...
                            <input type="hidden" name="keywords" autocomplete="off" class="form-control" value="无" >
                            {{--</div>--}}
                        {{--</div>--}}
...
{{--                            <textarea name="description" class="form-control" rows="4">{{  old('description', $article->description) }}</textarea>--}}
                            {{--<textarea name="description" type="hidden" class="form-control" rows="4">无</textarea>--}}
                            {{--</div>--}}
                        {{--</div>--}}
                        ...
                        {{--<input type="text" name="author" autocomplete="off" class="form-control" value="{{ old('author',$article->author) }}"--}}
                               ...
                               {{--maxlength="64"--}}
                        {{--></div>--}}
                        <input type="hidden" name="author" autocomplete="off" class="form-control" value="{{ old('author',$article->author) }}"
                               data-fv-trigger="blur"
                               minlength="1"
                               maxlength="64"
                        >
                        ...
                        {{--<div class="form-group has-feedback has-icon-right">--}}
                            ...
                            {{--></div>--}}
                        {{--</div>--}}
                        <input type="hidden" name="order" autocomplete="off" class="form-control" value="9999"
                               required
                               data-fv-trigger="blur"
                               min="1"
                               max="9999"
